...
ftpUN = os.environ.get('IHT_SFTP_USERNAME')
ftpPW = os.environ.get('IHT_SFTP_PASSWORD')
ftpHOST = os.environ.get('IHT_SFTP_ADDRESS')

auth = os.environ.get('IHT_AUTH_TOKEN')
peCourseNumbers = ['805', '806', '815', '816', '828', '829'] # the course numbers in PowerSchool that should be included in the export. Stored as strings because course numbers can be text in PS. So dumb
